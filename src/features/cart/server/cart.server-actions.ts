...
import { addToCartOrIncrementQuantity, createCartAndAddItems, createNewCartFromClosedCart, deleteCart, deleteCartItem, deleteCartItems, updateCartItem } from "./cart.service"
...
export async function deleteCartItemsAction(rawInput: z.infer<typeof deleteCartItemsSchema>) {
  const cartId = getCartCookie();
