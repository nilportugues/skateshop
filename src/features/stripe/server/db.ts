...
import { Order, orders, stores } from '@/libs/server/db/schema';
...
export type FindOrdersByEmailAndStore = Awaited<
    typeof findOrdersByEmailAndStore
>;
...
export async function countOrdersByEmailAndStore({
    email,
    store,
    statuses,
}: {
